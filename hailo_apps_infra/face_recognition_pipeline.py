...
class GStreamerDetectionApp(GStreamerApp):
    def __init__(self, app_callback, user_data):
        ...
        # Set the HEF file path based on the arch
            ...
            self.hef_path_detection = os.path.join(self.current_path, '/home/hailo/ronit/tappas/apps/h8/gstreamer/general/face_recognition/resources/scrfd_10g.hef')
            self.hef_path_recognition = os.path.join(self.current_path, '/home/hailo/ronit/tappas/apps/h8/gstreamer/general/face_recognition/resources/arcface_mobilefacenet_v1.hef')
    ...
    def get_pipeline_string(self):
        ...
        detection_pipeline = INFERENCE_PIPELINE(
            ...
            post_process_so='../resources/libscrfd.so',
            post_function_name="scrfd_10g_letterbox",
        ...
        mobile_facenet_pipeline = INFERENCE_PIPELINE(
            ...
            post_process_so="/usr/lib/aarch64-linux-gnu/hailo/tappas/post_processes/libface_recognition_post.so",
            post_function_name="filter",
            batch_size=self.batch_size,
            config_json=None,
            name='face_recognition_inference')
        cropper_pipeline = CROPPER_PIPELINE(inner_pipeline=(f'hailofilter so-path=../resources/libvms_face_align.so '
                                         ...
                                         so_path="/usr/lib/aarch64-linux-gnu/hailo/tappas/post_processes/cropping_algorithms/libvms_croppers.so",
